...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  pill:
    'bg-mahogany text-parchment border-2 border-blood hover:bg-mahogany-light hover:text-bone hover:border-blood-bright hover:shadow-lg hover:shadow-blood-bright/25 hover:scale-105 active:scale-95 backdrop-blur-md',
  ghost:
